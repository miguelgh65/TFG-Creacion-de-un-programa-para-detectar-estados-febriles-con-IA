...
from torch.autograd import Variable
   ...
   # Convertir Blue, green, red a Red, green, blue, cosas de openCV
def Convertir_RGB(img):
    ...
    # Convertir red, blue, green a Blue, green, red ,cosas de openCV
...
if __name__ == "__main__":
    ...
    print("estoy ejecutandome con la gpu mediante cuda" if torch.cuda.is_available() else "cpu")
    ...
    if opt.webcam==1:
        ...
        #guardar el video de la webcam en esa resolucion
        out = cv2.VideoWriter('output.mp4',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (1280,960))
    else:
    #guardar el video  en esa resolucion
    ...
    while cap:
        ...
        if ret is False:
            break
            #cambiamos a esa resolución mediante interpolacion cubica
